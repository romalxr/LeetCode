...
//        nums = new int[] { -1,1,4,-4,3,5,4,-2,3,-1 };
//        System.out.println(Arrays.toString(solution.topKFrequent(nums, 3)));
//        nums = new int[] { 5,3,1,1,1,3,73,1 };
//        System.out.println(Arrays.toString(solution.topKFrequent(nums, 1))); // [1]
//        nums = new int[] { 5,-3,9,1,7,7,9,10,2,2,10,10,3,-1,3,7,-9,-1,3,3 };
//        System.out.println(Arrays.toString(solution.topKFrequent(nums, 3))); // [10,9,2]
        ...
        System.out.println(Arrays.toString(solution.topKFrequent(nums, 7))); // [-12,-68,73,-55,-9,5,75]
    }
}
